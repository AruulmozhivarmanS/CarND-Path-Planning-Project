      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			double left_lane = 9999.0;
			double right_lane = 9999.0;
			double current_lane = 9999.0;
			bool left_rear = true;
			bool right_rear = true;
			int too_close = 0;
			double far_lane = 9999.0;
			bool far_rear = true;
...
<<<<<<< HEAD
					...
					else if (car_lane - lane == 2 || car_lane - lane == -2){
...
>>>>>>> 07e41b2cad61f1583c3ac92ae67b0c36e09d8ff2
			...
			vector<double> wpt_0 = getXY(car_s + 30, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
			vector<double> wpt_1 = getXY(car_s + 60, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);
			vector<double> wpt_2 = getXY(car_s + 90, (2+4*lane), map_waypoints_s, map_waypoints_x, map_waypoints_y);

			ptsx.push_back(wpt_0[0]);
			ptsx.push_back(wpt_1[0]);
			ptsx.push_back(wpt_2[0]);

			ptsy.push_back(wpt_0[1]);
